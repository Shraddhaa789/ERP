    ...
    try:
        ...
        for index, row in df.iterrows():
            ...
            outward_record = {
                ...
                'out_taxable_value': safe_str(row.get('Taxbale Value')),  # Note: typo in Excel
                'out_tsc': safe_str(row.get('TSC0.075%')),
                'out_discount': safe_str(row.get('Discont-2.4(HFCL')),  # Note: typo in Excel
                ...
                'out_loading_time': safe_str(row.get('loading Time')),  # Note: case
